  ...
  <div class="row">
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form action="<?php echo $action; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <div class="col-sm-5">
                        <img src="<?php echo base_url()."/image/profil_user/".$foto_profil?>" alt="" class="img-fluid">
                    </div>
                  </div>
                    <?php } else {?>
                  <div class="col-sm-12">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="varchar">Nomor Rekening <?php echo form_error('no_rekening') ?></label>
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="no_rekening" id="no_rekening" placeholder="Nomor Rekening" value="<?php echo $no_rekening; ?>" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="varchar">Nama Bank <?php echo form_error('no_rekening') ?></label>
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="nama_bank" id="nama_bank" placeholder="Nama Bank" value="<?php echo $nama_bank; ?>" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="varchar">Nama Rekening <?php echo form_error('nama_rekening') ?></label>
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="nama_rekening" id="nama_rekening" placeholder="Nama Rekening" value="<?php echo $nama_rekening; ?>" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="varchar">Nomor Wa <?php echo form_error('nomor_wa') ?></label>
              ...
              <div class="form-group">
                ...
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <div class="col-sm-5">
                        <img src="<?php echo base_url()."/image/sim/".$foto_sim?>" alt="" class="img-fluid">
                    </div>
                  </div>
                    <?php } else {?>
                  <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <div class="col-sm-5">
                        <img src="<?php echo base_url()."/image/stnk/".$foto_stnk?>" alt="" class="img-fluid">
                    </div>
                  </div>
                    <?php } else {?>
                  <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <div class="col-sm-5">
                        <img src="<?php echo base_url()."/image/kir/".$foto_kir?>" alt="" class="img-fluid">
                    </div>
                  </div>
                    <?php } else {?>
                  <div class="col-sm-12">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="int">Akses Aplikasi <?php echo form_error('status') ?></label>
                <div class="col-sm-12">
                <select name="status" id="status" class="form-control">
                <option value="<?=$status?>" selected><?=$status =="1" ? "Aktif":"Tidak Aktif"?></option>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="int">Blacklist <?php echo form_error('status') ?></label>
                <div class="col-sm-12">
                <select name="black_list" id="black_list" class="form-control">
                <option value="<?=$black_list?>" selected><?=$black_list =="1" ? "Ya":"Tidak"?></option>
              ...
              <div class="form-group">
                ...
                <option value="<?=$confirm?>"><?=$confirm == "1" ? "Confirmed" : "Unconfirm"  ?></option>
