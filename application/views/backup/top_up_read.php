      ...
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="tanggal_top_up" id="tanggal_top_up" placeholder="Tanggal Top Up" value="<?php echo $tanggal_top_up; ?>" readonly />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="nominal_top_up" id="nominal_top_up" placeholder="Nominal Top Up" value="<?php echo $nominal_top_up; ?>" readonly />
                </div>
              </div>
