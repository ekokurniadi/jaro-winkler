...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="#"> Target Order </a></div>
    </div>
  </div>
              ...
              <div class="form-group">
                ...
                <?php 
                    if($_SESSION['level']=="Admin"){
                      ...
                      $data = $this->db->query("SELECT * from grup where nama_up3='{$_SESSION['area_name']}'");
                    }
                  ?>
              ...
              <div class="form-group">
                ...
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <div class="col-sm-1">
                      <button type="button" id="searchCustomer" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><span class="fa fa-search"></span>  
                    </button>
                    </div>
                    <?php }else{ ?>
                      <div class="col-sm-1">
