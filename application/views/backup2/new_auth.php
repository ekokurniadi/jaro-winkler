...
<body style="background-image:url('<?php echo base_url()?>image/background.jpg');">
      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="login-brand">
              <img src="image/o.png" alt="logo" width="100"  style="margin-top:0px">
            </div>
            <!-- <h3 style="color:white;">PT INTI CAKRAWALA CITRA</h3> -->
            <p style="color:whitesmoke;text-shadow: 2px 2px black;">MTS Mahdaliyah</p>
            </div>
              ...
              <div class="card-body">
                ...
                <form accept-charset="UTF-8" role="form" class="form-signin">
                  <div class="form-group">
                    ...
                    <input id="nis" type="text" class="form-control" autocomplete="off" name="nis" tabindex="1" required autofocus>
                  ...
                  <div class="form-group">
                    ...
                    <input id="tanggal_lahir" autocomplete="off" type="date" class="form-control" name="tanggal_lahir" tabindex="2" required>
                    <div class="invalid-feedback">
