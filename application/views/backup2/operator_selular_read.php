      ...
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="kode_operator" id="kode_operator" placeholder="Kode Operator" value="<?php echo $kode_operator; ?>" readonly />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="nama_operator" id="nama_operator" placeholder="Nama Operator" value="<?php echo $nama_operator; ?>" readonly />
                </div>
              </div>
